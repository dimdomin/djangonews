...
from .views import NewsList, NewsDetail, SearchList, NewsCreate, ArticleCreate, NewsUpdate, ArticleList, \
   ArticleNewsList, ArticleUpdate, ArticleDelete, NewsDelete, ArticleDetail, subscribe, CategoryListView
